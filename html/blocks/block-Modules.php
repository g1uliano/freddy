...
global $prefix, $db, $admin;
    ...
    $content .= "<center><b>Módulo Ativos</b><br><font class=\"tiny\">(Visiveis no Menu)</font></center><br>\n";
	...
	while ($row5 = $db->sql_fetchrow($result5)) {
	    ...
	    if ($mn_title2 != "") {
		$content .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"area.php?nome=$mn_title\">$mn_title2</a><br>\n";
		$dummy = 1;
	    } else {
		$a = 1;
	    }
