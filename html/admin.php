...
// Descomente caso seja necessário aumentar sua segurança
...
if(isset($admin) && $admin != "") {
  ...
  if ($aid=="" || $pwd=="") {
    ...
    echo "<font face=\"Verdana\" size=\"+4\"><b>Vá embora, agora!</b></font></center>\n";
    echo "</body>\n";
    echo "</html>\n";
    exit;
  }
...
function adminMain() {
    ...
    CloseTable();
    echo "<br>";
    #Verificador de Atualizações - Adicionado no Freddy 0.6
    ...
    OpenTable();
    echo "<center><b>Disponivel nova versão do Freddy: Freddy $versao_atual<br> <a href=\"http://freddy.codigolivre.org.br/index.php?area=downloads\">[Para baixar a nova versão do Freddy clique aqui]</a>.</b></center>";
    CloseTable();
    echo "<br>";
    }
    OpenTable();
    ...
    $who_online = "<center><font class=\"option\">Quem está on-line</font><br><br><font class=\"content\">"._CURRENTLY." $guest_online_num $xptz<br>";
    ...
    echo "<b>Administrador, Seu IP é:</b> ";
    echo "[";
