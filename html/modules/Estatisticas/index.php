...
function Stats_Main() {
	...
	."[ <a href=\"area.php?nome=$module_name&op=Stats\">"._VIEWDETAILED."</a> ]</center>";
    CloseTable();
    echo "<br><br>";
...
function Stats($total) {
	...
	."[ <a href=\"area.php?nome=$module_name\">"._RETURNBASICSTATS."</a> ]</center>";
...
function YearlyStats($year){
    ...
    echo "<BR>";
    echo "<center>[ <a href=\"area.php?nome=$module_name\">"._BACKTOMAIN."</a> | <a href=\"area.php?nome=$module_name&amp;op=Stats\">"._BACKTODETSTATS."</a> ]</center>";
    closetable();
    include ("footer.php");
}
...
function showYearStats($nowyear){
	...
	if ($year != $nowyear) {
	    echo "<a href=\"area.php?nome=$module_name&amp;op=YearlyStats&amp;year=$year\">$year</a>";
	} else {
	    echo "$year";
	}
	echo "</td><td>";
...
function showMonthStats($nowyear,$nowmonth){
	...
	echo "<tr bgcolor=\"$bgcolor1\"><td>";
	if ($month != $nowmonth) {
	    echo "<a href=\"area.php?nome=$module_name&amp;op=MonthlyStats&amp;year=$nowyear&amp;month=$month\" class=\"hover_orange\">";
	    getmonth($month);
	    echo "</a>";
	} else {
	    getmonth($month);
...
function showDailyStats($year,$month,$nowdate){
	...
	echo "<tr bgcolor=\"$bgcolor1\"><td>";
	if ($date != $nowdate) {
	    echo "<a href=\"area.php?nome=$module_name&amp;op=DailyStats&amp;year=$year&amp;month=$month&amp;date=$date\" class=\"hover_orange\">";
	    echo $date;
	    echo "</a>";
	} else {
	    echo $date;
